...
import { BookOpen, Book, ScrollText, ArrowRight } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-10">
          ...
          <div className="mt-6 flex justify-center">
            <Button asChild variant="outline" className="border-amber-500/50 text-amber-700 hover:bg-amber-100 dark:text-amber-500 dark:hover:bg-amber-900/50">
              <Link href="/library/gita">
